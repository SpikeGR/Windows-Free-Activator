@echo off
title Windows Free Activator V2.3

:checkforupdates
echo //------------------
echo  Windows Free Activator V2.3
...
:downloadupdate
echo.
echo The update will be downloaded inside the "Updater" folder as "WindowsFreeActivator.rar"
timeout 3 > nul
powershell -Command "Invoke-WebRequest https://rebrand.ly/WindowsFreeActivator" -OutFile WindowsFreeActivator.rar
timeout 1 > nul
echo.
