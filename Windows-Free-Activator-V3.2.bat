@echo off
title Windows Free Activator V3.2
color 1e
...
echo.
echo Make sure your device has the latest Windows Updates installed and that there
echo are no any updates pending or else the activation might fail.
echo.
